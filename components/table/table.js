...
var Table = /** @class */ (function () {
    ...
    Table.prototype.isRowExpanded = function (rowData) {
        return this.expandedRowKeys[String(objectutils_1.ObjectUtils.resolveFieldData(rowData, this.dataKey))] === 1;
    };
...
var ScrollableView = /** @class */ (function () {
    ...
    ScrollableView.prototype.ngAfterViewInit = function () {
        ...
        if (!this.frozen) {
            ...
            this.scrollBodyViewChild.nativeElement.style.marginBottom = domhandler_1.DomHandler.calculateScrollbarWidth() + 'px';
...
var EditableColumn = /** @class */ (function () {
    ...
    EditableColumn.prototype.findCell = function (element) {
        if (element) {
            var cell = element;
            while (cell && !domhandler_1.DomHandler.hasClass(cell, 'ui-editable-column')) {
    ...
    EditableColumn.prototype.moveToNextDownCell = function (event) {
        var currentCell = this.findCell(event.target);
        var row = currentCell.parentElement;
        var targetCell = this.findNextEditableRowCell(currentCell);
        if (targetCell) {
            domhandler_1.DomHandler.invokeElementMethod(event.target, 'blur');
            domhandler_1.DomHandler.invokeElementMethod(targetCell, 'click');
            event.preventDefault();
    ...
    EditableColumn.prototype.findNextEditableRowCell = function (cell) {
        var nextCell = null;
